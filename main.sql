...
INSERT INTO bands (name)
VALUES ('Kaytranada'), ('Disclosure'), ('McSlambley');
...
VALUES ('Skin', 2017, 1), ('Hello, my name is Flume', 2019, 1), ('Bubba', 2019, 2), ('99.9%', 2017, 2), ('Baby Steps', 2020, 4), ('Settle', 2013, 3); 
...
SELECT * FROM albums 
WHERE release_year BETWEEN 1900 AND 2018;
...
SELECT band_id AS Band, COUNT(band_id) AS Albums FROM albums
GROUP BY band_id;
